...
public class SignedEvidenceCombinedTest {
    ...
    public void simple() throws Exception {
        ...
        SignedEvidenceWriter.write(outputStream, TestResources.getPrivateKey(), EvidenceCombinedTest.EVIDENCE);
        ...
        Assert.assertEquals(evidenceSigned.getContent(), EvidenceCombinedTest.EVIDENCE);
    }
}
