...
import network.oxalis.vefa.peppol.mode.classes.ProductionObject;
import network.oxalis.vefa.peppol.mode.classes.SomeObject;
import network.oxalis.vefa.peppol.mode.classes.TestObject;
