...
import network.oxalis.vefa.peppol.common.api.PerformResult;
...
public abstract class AbstractPublisherSyntax implements PublisherSyntax {
    ...
    private static final DatatypeFactory DATATYPE_FACTORY =
            ExceptionUtil.perform(IllegalStateException.class,
                    (PerformResult<DatatypeFactory>) DatatypeFactory::newInstance);

    protected XMLGregorianCalendar convert(final Date date) {
        if (date == null)
            return null;
