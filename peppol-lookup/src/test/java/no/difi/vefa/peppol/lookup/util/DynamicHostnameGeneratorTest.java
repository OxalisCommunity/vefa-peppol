...
public class DynamicHostnameGeneratorTest {
    ...
    public void simpleMd5() throws LookupException {
        ...
        assertEquals(generator.generate(new ParticipantIdentifier("9908:difi")), "B-42fabff13df16391dbd1f01b7c05d0e7.iso6523-actorid-upis.edelivery.tech.ec.europa.eu");
        assertEquals(generator.generate(new ParticipantIdentifier("9908:DIFI")), "B-42fabff13df16391dbd1f01b7c05d0e7.iso6523-actorid-upis.edelivery.tech.ec.europa.eu");
    }
